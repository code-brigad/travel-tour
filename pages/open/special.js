                        ...
                        return (
                            <li key={i}>
                                <div className='w-full h-auto'>
                                    <Image src={pack.photo} alt={pack.city} height={200} width={200} className='w-full' />
                                </div>
                                <TextHeading className="text-[26px] font-bold">{pack.city}</TextHeading>
                                <div className="flex flex-row gap-2">
                                    ...
                                    <TextSubtitle className="!text-black sm:text-[16px] text-[14px]">
                                        {i18n.language == "uz" ? (
